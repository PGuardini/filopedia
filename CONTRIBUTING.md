...
Queremos que você saiba que aqui ninguém precisa enfrentar esse caminho sem apoio. Se preferir um espaço mais reservado, você pode mandar um e-mail para [pguardini.trabalho@gmail.com](mailto:pguardini.trabalho@gmail.com) e teremos o maior prazer em ajudar. Seja para tirar dúvidas, pedir orientação ou simplesmente ter alguém para conversar sobre como começar.
...
- [Contribuindo](#contribuindo)
  ...
  - [Primeira Contribuição](#primeira-contribuição)
    ...
    - [7. Execute a filopedia Localmente](#7-execute-a-filopedia-localmente)
...
### 7. Execute a filopedia Localmente

Para executar o projeto, leia a seção [utilização][readme] do arquivo `README.md` do projeto.
...
remote:      https://github.com/PGuardini/filopedia/pull/new/386
remote:
To github.com:PGuardini/filopedia.git
 * [new branch]      386 -> 386
```
...
- **Exemplo**: Em vez de “Nova funcionalidade”, use “Adiciona a funcionalidade `pesquisar_filosofos` para listar os filósofos ”
- **Benefícios**:
...
- **Exemplo**:
Este PR adiciona o utilitário listar_filosofos para converter os nomes de filósofos em listas. Resolve a issue #474, melhorando a iteração dos filósofos. A função inclui validação de entrada e testes atualizados.
- **Benefícios**:
...
[readme]: https://github.com/PGuardini/filopedia/blob/main/README.md#utilização